...
import { getSongDetail, getLyric, getSimiPlaylist } from '@/services/player'
...
const changeSimiSongsAction = simiPlaylist => ({
...
export const getSimiPlayListAction = () => {
  return (dispatch, getState) => {
    ...
    getSimiPlaylist(id).then(res => {
      dispatch(changeSimiSongsAction(res.playlists))
    })
  }
}